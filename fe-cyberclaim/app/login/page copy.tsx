        ...
        <form className="mt-8 space-y-6" onSubmit={handleSubmit}>
          <div className="space-y-4">
            <div>
              ...
              <input
                ...
                className="appearance-none relative block w-full px-3 py-3 border border-gray-300 placeholder-gray-500 text-gray-900 rounded-xl focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-colors"
          ...
          <div className="mt-6 p-4 bg-blue-50 rounded-xl border border-blue-200">
            ...
            <div className="text-xs text-blue-700 space-y-1">
              <div><strong>Superadmin:</strong> superadmin@cyberclaim.id / password</div>
              <div><strong>Admin:</strong> admin@cyberclaim.id / password</div>
              <div><strong>Verifikator:</strong> verifikator@cyberclaim.id / password</div>
            </div>
          </div>
        </form>
      </div>
