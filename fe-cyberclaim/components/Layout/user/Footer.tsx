// components/Layout/Homepage/Footer.tsx
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
            ...
            <div className="lg:col-span-2">
              <div className="flex items-center space-x-3 mb-4">
                ...
                <div>
                  ...
                  <div className="text-xs text-gray-400 -mt-1">by HealthTech Indonesia</div>
                </div>
              </div>
              <p className="text-gray-400 mb-6 max-w-md">
                Sistem verifikasi klaim BPJS berbasis kecerdasan buatan yang mengotomatiskan 
                pengecekan dokumen, validasi rekam medis, dan deteksi fraud dengan teknologi terkini.
              </p>
          ...
          <div className="border-t border-gray-800 mt-8 pt-8 flex flex-col md:flex-row justify-between items-center">
            <div className="text-gray-400 text-sm mb-4 md:mb-0">
              © 2024 CyberClaim. All rights reserved. By HealthTech Indonesia.
            </div>
          ...
          <div className="mt-8 pt-8 border-t border-gray-800">
            <p className="text-center text-gray-400 text-sm mb-4">Tersertifikasi & Dipercaya Oleh</p>
            <div className="flex flex-wrap justify-center items-center gap-6 opacity-75">
              <div className="bg-white/10 rounded-lg px-4 py-2 text-xs">ISO 27001 Certified</div>
              <div className="bg-white/10 rounded-lg px-4 py-2 text-xs">Kemenkes RI</div>
              <div className="bg-white/10 rounded-lg px-4 py-2 text-xs">BPJS Kesehatan</div>
              <div className="bg-white/10 rounded-lg px-4 py-2 text-xs">HIPAA Compliant</div>
              <div className="bg-white/10 rounded-lg px-4 py-2 text-xs">GDPR Ready</div>
            </div>
          </div>
        </div>
      </footer>
